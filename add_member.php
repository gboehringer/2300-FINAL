...
if (isset($_POST['submit'])) {
  ...
  //validation for major
      ...
      $add = "INSERT INTO Members (net_id,firstName,lastName,middleName,grad_year,major,headshot_path,resume_path) VALUES('$net','$firstname','$lastname','$middlename','$year','$major','$pathheadshot','$pathresume')";
